                ...
                @if (isset($step['component']))
                    ...
                    <div class="mt-auto flex justify-end gap-3">
                        ...
                        @if ($currentIndex === $steps->count() - 1)
                            <button class="btn-primary mt-12 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-wait" wire:click="completeStep" wire:loading.attr="disabled" wire:target="completeStep">
                        ...
                        @else
                            <button class="btn-primary mt-12 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-wait" wire:click="completeStep" wire:loading.attr="disabled" wire:target="completeStep" @disabled(!$canProceed)>
                                <span wire:loading.remove wire:target="completeStep">
                                    {{ __('Next') }}
                                </span>
